...
const Home: NextPage<indexType> = ({ data, projects }) => {
    ...
    return (
        <>
            <div className="main grid gird-rows-2 md:grid-cols-[7fr,3fr]">
                <span id='backSp'>
            ...
            <div className="sort_about mt-4 p-4">
                ...
                <ol className="relative border-l ml-4 border-amber-600 dark:border-amber-700">
                    <li className="mb-10 ml-4">
                        ...
                        <time className="mb-1 text-sm font-normal leading-none text-amber-700 md:w-1/2">2017</time>
                        <h3 className="text-lg font-semibold text-amber-900 dark:text-white">Started my journey</h3>
                        <p className="mb-4 text-base font-normal text-amber-700 md:w-1/2 dark:text-amber-400">This year I found something I was looking for.</p>
                    ...
                    <li className="mb-10 ml-4">
                        <div className="absolute w-3 h-3 bg-amber-600 rounded-full mt-1.5 -left-1.5 border border-white dark:border-amber-900 dark:bg-amber-700"></div>
                        <time className="mb-1 text-sm font-normal leading-none text-amber-700 md:w-1/2">2018</time>
                        <h3 className="text-lg font-semibold text-amber-900 dark:text-white">I proceeded with my interest</h3>
                        <p className="text-base font-normal text-amber-700 md:w-1/2 dark:text-amber-400">Worked as a freelancer technical assistant, in my village with some of my friends.</p>
                    </li>
                    <li className="ml-4 mb-10">
                        <div className="absolute w-3 h-3 bg-amber-600 rounded-full mt-1.5 -left-1.5 border border-white dark:border-amber-900 dark:bg-amber-700"></div>
                        <time className="mb-1 text-sm font-normal leading-none text-amber-700 md:w-1/2">2019</time>
                        <h3 className="text-lg font-semibold text-amber-900 dark:text-white">Started, a new journey</h3>
                        <p className="text-base font-normal text-amber-700 md:w-1/2 dark:text-amber-400">A lot happened this year, and in the bowels of the year, I had become an engineering student.</p>
                    </li>
                    <li className="ml-4 mb-10">
                        <div className="absolute w-3 h-3 bg-amber-600 rounded-full mt-1.5 -left-1.5 border border-white dark:border-amber-900 dark:bg-amber-700"></div>
                        <time className="mb-1 text-sm font-normal leading-none text-amber-700 md:w-1/2">2020</time>
                        <h3 className="text-lg font-semibold text-amber-900 dark:text-white">Learn, Break, Learn phase</h3>
                        <p className="text-base font-normal text-amber-700 md:w-1/2 dark:text-amber-400">I learned most of the engineering stuff as well as my areas of interest like programming, designing, etc.</p>
                    </li>
                    <li className="ml-4 mb-10">
                        <div className="absolute w-3 h-3 bg-amber-600 rounded-full mt-1.5 -left-1.5 border border-white dark:border-amber-900 dark:bg-amber-700"></div>
                        <time className="mb-1 text-sm font-normal leading-none text-amber-700 md:w-1/2">2021</time>
                        <h3 className="text-lg font-semibold text-amber-900 dark:text-white">Freelancing start</h3>
                        <p className="text-base font-normal text-amber-700 md:w-1/2 dark:text-amber-400">I did some freelance development work as well as some technical stuff.</p>
                    </li>
                    <li className="ml-4">
                        <div className="absolute w-3 h-3 bg-amber-600 rounded-full mt-1.5 -left-1.5 border border-white dark:border-amber-900 dark:bg-amber-700"></div>
                        <time className="mb-1 text-sm font-normal leading-none text-amber-700 md:w-1/2">2022</time>
                        <h3 className="text-lg font-semibold text-amber-900 dark:text-white">Learning, Building, and Writing</h3>
                        <p className="text-base font-normal text-amber-700 md:w-1/2 dark:text-amber-400">{"I think it's going to be an interesting year because this year I tried to do all the things I had to do."}</p>
                    </li>
                </ol>
            </div>
